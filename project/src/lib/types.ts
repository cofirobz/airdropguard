...
export interface Airdrop {
  ...
  scam_warnings?: string[] | null;
  missing_information?: string[] | null;
  sources_checked?: string[] | null;
  opportunity_intelligence?: Record<string, unknown> | null;
  ai_reasoning?: Record<string, unknown> | null;
  human_decision?: string | null;
  ai_recommendation_override?: 'verify' | 'review_further' | 'blacklist' | null;
  human_override_score?: number | null;
  final_published_score?: number | null;
